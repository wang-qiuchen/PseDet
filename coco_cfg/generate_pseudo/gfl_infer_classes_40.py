...
stage_index = 0
num_classes = 40
classes_groups=[40,40]
## generate pseudo
pkl_out_file_path='./work_dirs/pseudo_kmeans_40.pkl'
buffer_size = 100
...
val_evaluator = [
    ...
    dict(
        type='DumpDetResults',
        out_file_path=pkl_out_file_path
    ),
    dict(
...
tta_model = dict(
    ...
    tta_cfg=dict(nms=dict(type='nms',iou_threshold=0.4),
                 max_per_img=100,
                 kmeans=True,buffer_size=(num_classes,buffer_size)))

img_scales = [ (666, 400),(1333, 800), (2000, 1200)]
tta_pipeline = [
