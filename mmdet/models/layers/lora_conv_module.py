...
class LoRA_ConvModule(nn.Module):
    ...
    def __init__(self,
        ...
        self.in_channels = self.conv.conv.in_channels
        self.out_channels = self.conv.conv.out_channels
        self.kernel_size = self.conv.conv.kernel_size
        self.stride = self.conv.conv.stride
        self.padding = padding
        self.dilation = self.conv.conv.dilation
        self.transposed = self.conv.conv.transposed
        self.output_padding = self.conv.conv.output_padding
        self.groups = self.conv.conv.groups

        if self.with_spectral_norm:
            self.conv.conv = nn.utils.spectral_norm(self.conv.conv)
